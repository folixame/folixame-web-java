 ...
 *
 */
@WebServlet("/crearimagenes")
public class CreateImagesServlet extends HttpServlet {
	UsersWSClient client;

	/**
	 * 
	 */
	public CreateImagesServlet() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if(req.getSession().getAttribute("permission").equals("admin")) {
			req.getRequestDispatcher("/WEB-INF/crearimagenes.jsp").forward(req, resp);
		} else {
